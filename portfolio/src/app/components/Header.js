export default function Header() {
	return (
		<header className="w-full">
			<div className="max-w-5xl mx-auto px-8 py-6 flex items-center justify-between glass">
				<div className="flex items-center gap-4">
					<div className="w-10 h-10 rounded-lg bg-gradient-to-br from-violet-600 to-teal-400 flex items-center justify-center shadow-md">
						<span className="text-white font-bold">MB</span>
					</div>
					<div>
						<div className="text-lg font-semibold">Muhammad Bilal</div>
					</div>
				</div>
				...
				<div className="flex items-center gap-8">
					<nav className="flex items-center gap-6 text-lg">
						<a
							className="px-4 py-2 rounded-lg hover:bg-black/[.03] dark:hover:bg-white/[.03] transition-colors relative group"
							href="/"
						>
							<span>Home</span>
							<span className="absolute bottom-0 left-0 w-full h-0.5 bg-gradient-to-r from-violet-600 to-teal-400 transform scale-x-0 transition-transform group-hover:scale-x-100"></span>
						</a>
						<a
							className="px-4 py-2 rounded-lg hover:bg-black/[.03] dark:hover:bg-white/[.03] transition-colors relative group"
							href="/about"
